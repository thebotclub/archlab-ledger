...
while True:
    ...
    if failures:
        ...
        cd = [r for r in rows if r["arm"] == "onorm_qknorm"]
        ...
        gates = {
            ...
            "onorm_qknorm_transitions_ge_10": cd_tr >= g["onorm_qknorm_transitions_min"],
        ...
        out = {"campaign": R.name, "stage": m["stage"], "claim_eligible": True,
               ...
               "onorm_qknorm_transitions": cd_tr, "gla_transitions": gl_tr, "n_pairs": n,
               "fisher_exact_one_sided_p": pf,
               "onorm_qknorm_recalls": [round(r["recall"], 4) for r in cd],
