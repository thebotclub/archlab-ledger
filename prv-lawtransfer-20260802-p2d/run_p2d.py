...
OUT_DIR = os.path.expanduser("~/archlab-p2d")
CORPUS = os.path.expanduser("~/archlab-s05/data/train.bin")
EVAL_SEED = 3379290924
FILLER_OFFSET = 600000
...
def main():
    ...
    }, open(f"{OUT_DIR}/p2d_{args.tag}.json", "w"), indent=1)
    log(f"wrote {OUT_DIR}/p2d_{args.tag}.json")
